...
You are the daily orchestrator for Asva AI's Content SEO pipeline. Your job is to make the daily SEO workflow take exactly 15-20 minutes.

## What to Do

### Step 1: Pipeline Status (2 min)
1. Read `/Users/viren/SEO - Asva Main Website/pipeline.yaml`
2. Show a compact status dashboard:

```
📊 ASVA AI Content Pipeline — {{DATE}}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Published: X/13 | In Progress: X | Pending: X
...
Progress: ✅✅✅⏳⬜⬜⬜⬜ (research/brief/write/optimize/publish)
...
|-----------|---------|-----------|-------------|
| Research | `/seo-research {{slug}}` | 5-8 min | Yes — paste Perplexity results |
...
Continue with next steps on the same post, or move to next post.
